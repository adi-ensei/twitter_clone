...
export const commentOnPost = async (req, res) => {
  try {
    ...
    await post.save();
    return res.status(200).json({ message: "Commented successfully", post });
  } catch (error) {
...
export const getAllPost = async (req, res) => {
  try {
    ...
    console.log(error, "Error in getAllPost controller");
...
export const getLikedPosts = async (req, res) => {
  ...
  try {
    ...
    console.log(error, "Error in getLikedPosts controller");
    res.status(500).json({ error: "Internal server error" });
  }
};
export const getFollowingPosts = async (req, res) => {
  try {
    ...
    console.log(error, "Error in getFollowingPosts contoller");
    res.status(500).json({ error: "Internal Server Error" });
  }
};
